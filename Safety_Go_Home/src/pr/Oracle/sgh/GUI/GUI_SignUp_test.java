...
public class GUI_SignUp_test extends JFrame {
	...
	public GUI_SignUp_test() {
		...
		JCheckBox checkBox = new JCheckBox("\uC774\uC6A9\uC57D\uAD00 \uBC0F \uAC1C\uC778\uC815\uBCF4 \uC81C\uACF5\uC5D0 \uB3D9\uC758\uD569\uB2C8\uB2E4.");
		checkBox.setFont(new Font("\uACBD\uAE30\uCC9C\uB144\uC81C\uBAA9 Light", checkBox.getFont().getStyle(), checkBox.getFont().getSize()));
