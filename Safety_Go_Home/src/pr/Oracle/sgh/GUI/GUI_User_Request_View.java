...
public class GUI_User_Request_View extends JFrame {
	...
	public GUI_User_Request_View() {
		...
		JButton btn_search_startSpot = new JButton("\uAC80\uC0C9");
		btn_search_startSpot.setFont(new Font("경기천년제목 Light", Font.PLAIN, 15));
		btn_search_startSpot.setBounds(269, 26, 57, 26);
		panel_2.add(btn_search_startSpot);
		...
		JButton btn_search_goalSpot = new JButton("\uAC80\uC0C9");
		btn_search_goalSpot.setFont(new Font("경기천년제목 Light", Font.PLAIN, 15));
		btn_search_goalSpot.setBounds(269, 71, 57, 26);
		panel_2.add(btn_search_goalSpot);
		...
		JButton btn_matching = new JButton("\uB9E4\uCE6D \uC2E0\uCCAD");
