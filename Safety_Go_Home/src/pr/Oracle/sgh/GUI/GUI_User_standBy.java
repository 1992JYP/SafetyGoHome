...
public class GUI_User_standBy extends JFrame {
	...
	public GUI_User_standBy() {
		...
		JPanel panel_userStandBy_userInfo = new JPanel();
		panel_userStandBy_userInfo.setLayout(null);
		panel_userStandBy_userInfo.setBounds(52, 207, 338, 142);
		panel_1.add(panel_userStandBy_userInfo);
		
		Panel panel_3 = new Panel();
		panel_3.setBackground(new Color(255, 222, 173));
		panel_3.setBounds(27, 36, 96, 94);
		panel_userStandBy_userInfo.add(panel_3);
		...
		panel_userStandBy_userInfo.add(lbl_user_name);
		...
		panel_userStandBy_userInfo.add(lbl_grade);
		...
		panel_userStandBy_userInfo.add(lbl_using);
		...
		panel_userStandBy_userInfo.add(lbl_using_count);
		...
		panel_userStandBy_userInfo.add(lbl_user_star);
		...
		panel_userStandBy_userInfo.add(lbl_user_star_score);
		...
		panel_userStandBy_userInfo.add(btn_Info);
