...
public class GUI_Watcher_standBy extends JFrame {
	public GUI_Watcher_standBy() {
		...
		JLabel lbl_watcher_name = new JLabel("\uAC10\uC2DC\uC790 \uC774\uB984");
		...
		panel.add(lbl_watcher_star_score);
